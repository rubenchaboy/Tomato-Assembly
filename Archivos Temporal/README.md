...
- `Analisis temporal.Rmd`/` Analisis temporal.html`: el script tanto en formato _.Rmd_ como _.html_ con el código utilizado para desarrollar los análisis de este capítulo.  
