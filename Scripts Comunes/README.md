En esta carpeta se encuentran los scripts que son comunes a todos los capítulos. 
...
1. `remove_341F_805R.py`. Eliminación de las secuencias correspondientes a los primers. 
